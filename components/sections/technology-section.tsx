...
function ScrollRevealText({ text }: { text: string }) {
  ...
  return (
    <p
      ref={containerRef}
      className="text-3xl font-display leading-snug md:text-4xl lg:text-5xl"
    >
...
const sideImages = [
  {
    src: "https://images.unsplash.com/photo-1634141510639-d691d86f47be?q=80&w=1000",
    alt: "Production line",
    position: "left",
    span: 1,
  },
  {
    src: "https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?q=80&w=1000",
    alt: "Cows in pasture",
    position: "left",
    span: 1,
  },
  ...
  {
    src: "https://images.unsplash.com/photo-1587049352846-4a222e784d38?q=80&w=1000",
    alt: "Laboratory",
    position: "right",
    span: 1,
  },
...
export function TechnologySection({ dict }: { dict: Dictionary["technology"] }) {
    ...
    <section ref={sectionRef} className="relative bg-foreground">
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-display italic leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {dict.titleWords.map((word, index) => {
                    ...
                    return (
                      <span
                        ...
                        style={{
                          ...
                          marginRight: index < dict.titleWords.length - 1 ? '0.3em' : '0',
                        }}
                      >
                        {word}
                        {index === 1 && <br />}
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          <ScrollRevealText text={dict.descriptionText} />
        </div>
      </div>
    </section>
  );
